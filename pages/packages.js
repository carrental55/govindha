...
const packagesData = [
  ...
  {
    id: "3",
    title: "Srikalahasti Package",
    code: "2",
    images: ["/images/kalahasti.jpg", "/images/padmavathi2.jpg"],
    short: "Visit both srikalahasti temple comfortably with professional drivers and well-maintained vehicles.",
    inclusions: "Toll gate, parking charges, driver allowance, and fuel included.",
    exclusions: "Darshan tickets, entrance tickets, accommodation, and driver food (Rs.200 extra during meal time).",
    terms: [
      "Extra charges apply if distance/time exceeds limit.",
  ...
  {
    id: "4",
    title: "Kanipakam  Package",
    code: "2",
    images: ["/images/kanipakam.jpg", "/images/padmavathi2.jpg"],
    short: "Visit both Kanipaka temples comfortably with professional drivers and well-maintained vehicles.",
    inclusions: "Toll gate, parking charges, driver allowance, and fuel included.",
    exclusions: "Darshan tickets, entrance tickets, accommodation, and driver food (Rs.200 extra during meal time).",
    terms: [
      "Extra charges apply if distance/time exceeds limit.",
  ...
  {
    id: "5",
    title: "Golden Temple Package - Vellore",
    code: "2",
    images: ["/images/goldentemple.jpg", "/images/padmavathi2.jpg"],
    short: "Visit both Golden Temple temple comfortably with professional drivers and well-maintained vehicles.",
    inclusions: "Toll gate, parking charges, driver allowance, and fuel included.",
    exclusions: "Darshan tickets, entrance tickets, accommodation, and driver food (Rs.200 extra during meal time).",
    terms: [
      "Extra charges apply if distance/time exceeds limit.",
  ...
  {
    id: "6",
    title: "Arunachalam Temple Package",
    code: "2",
    images: ["/images/arunachalam.jpg", "/images/padmavathi2.jpg"],
    short: "Visit both Arunachalam Temple temples comfortably with professional drivers and well-maintained vehicles.",
    inclusions: "Toll gate, parking charges, driver allowance, and fuel included.",
    exclusions: "Darshan tickets, entrance tickets, accommodation, and driver food (Rs.200 extra during meal time).",
    terms: [
      "Extra charges apply if distance/time exceeds limit.",
